    ...
    <div class="col-md-12">
      <div class="page-header">
        <h2>
          ...
          <div class="pull-right btn-tambah" style="width: 100% !important;">
...
<?php  
  ...
  ?>
        ...
        <tbody>
              ...
              $no = 1;
              if (isset($cari)) {
                $query = mysqli_query($conn, "SELECT * FROM donatur
                                            WHERE id_donatur LIKE '%$cari%' OR nama_donatur LIKE '%$cari%' 
                                            ORDER BY id_donatur DESC LIMIT $mulai, $batas") 
                                            or die('Ada kesalahan pada query donatur: '.mysqli_error($conn));
              } else {
                $query = mysqli_query($conn, "SELECT * FROM donatur
                                            ORDER BY id_donatur DESC LIMIT $mulai, $batas")
                                            or die('Ada kesalahan pada query donatur: '.mysqli_error($conn));
