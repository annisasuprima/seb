...
?>
  ...
  if (empty($_GET['alert'])) {
    ...
    echo "<div class='alert alert-success alert-dismissible' role='alert'>
            ...
            <strong><i class='glyphicon glyphicon-ok-circle'></i> Sukses!</strong> Data Bantuan berhasil disimpan.
          </div>";
  } elseif ($_GET['alert'] == 3) {
    echo "<div class='alert alert-success alert-dismissible' role='alert'>
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            ...
            <strong><i class='glyphicon glyphicon-ok-circle'></i> Sukses!</strong> Data Bantuan berhasil diubah.
          </div>";
  } elseif ($_GET['alert'] == 4) {
    echo "<div class='alert alert-success alert-dismissible' role='alert'>
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            ...
            <strong><i class='glyphicon glyphicon-ok-circle'></i> Sukses!</strong> Data Bantuan berhasil dihapus.
          </div>";
  }
  ?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Data Bantuan</h3>
        </div>
        <div class="panel-body">
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              if (isset($cari)) {
                $jumlah_record = mysqli_query($db, "SELECT * FROM bantuan
              ...
              $no = 1;
              if (isset($cari)) {
                $query = mysqli_query($db, "SELECT * FROM bantuan
                                            WHERE id_bantuan LIKE '%$cari%' OR jenis_bantuan LIKE '%$cari%' 
