...
$hasil = mysqli_query($conn,"select * from kerugian join detail_kerugian on kerugian.id_kerugian=detail_kerugian.id_kerugian join kejadian_bencana on detail_kerugian.jenis_bencana=kejadian_bencana.jenis_bencana");
...
<!-- kerugian.id_kerugian, kejadian_bencana.jenis_bencana, kejadian_bencana.tgl_bencana, kejadian_bencana. no_urut, detail_kerugian.total_kerugian  -->