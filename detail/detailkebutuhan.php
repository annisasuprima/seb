...
$hasil = mysqli_query($conn,"select * from bantuan join detail_kebutuhan on bantuan.id_korban=detail_kebutuhan.id_korban join detail_korban on detail_kebutuhan.nik_korban=detail_korban.nik_korban ");
